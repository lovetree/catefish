...
//上传类
class UploadFile {
	public $maxSize = 1048576; // 上传文件的最大值，默认1M
	...
	public function __construct($savePath="../upload_files", $allowExts = array('gif','jpg','jpeg','bmp','png'), $maxSize = 1048576) {
		$this->savePath = $savePath.'/'.date('Y-m-d').'/';
