...
class PackageController extends BaseController {
    ...
    public function init() {
        if (!$this->model){
            $this->model = new \Gamemt\PackageModel();
        }
    }
    ...
    public function listAction() {
        ...
        $pageInfo['pageUrl'] = '/gamemt/package/list';
    ...
    public function infoAction() {
        ...
        //查询数据
        $data = $this->model->_info($page, $pagesize, $args);
        //数据重构
        $list = $data['list'];
        unset($data['list']);
        $ret_list = [];
        ...
        $pageInfo['pageCount'] = $data['pageCount'];
        $pageInfo['total'] = $data['total'];
        $pageInfo['pageUrl'] = '/gamemt/package/info';
        $this->getView()->assign('pageInfo', $pageInfo);
        $this->walkData($ret_list);
        $this->getView()->assign('list', $ret_list);
        $this->display('info');
