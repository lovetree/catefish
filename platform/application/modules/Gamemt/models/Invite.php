...
class InviteModel extends \BaseModel {
    ...
    public function create(array $params = []) {
        $params = array_fetch($params, 'id','invite_date','user_id','prize_for_tg','prize_total','invite_way','btg_user_id','prize_for_btg','status');
        $model = $this->DB()->getTable('ms_invite');
