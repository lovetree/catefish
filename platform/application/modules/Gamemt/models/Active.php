...
class ActiveModel extends \BaseModel {
    ...
    private $tb = 'ms_active';
    private $p_l = ['id', 'title', 'image', 'link', 'link_type', 'game_type', 'game_mode', 'a_sort', 'start_time', 'end_time', 'status', 'u_time', 'updated_uid'];
    private $p_s = ['id', 'title', 'image', 'link', 'link_type', 'game_type', 'game_mode', 'a_sort', 'start_time', 'end_time'];
    private $model = [];
    private $select = [];
    public $keys = [];
    public $valid = [];
