...
define('PK_RANK_POINT_DATE', 'rank_point_date');      //键格式 - 积分排行榜更新日期
...
define('RK_RANK_POINT', 'rank_point');            //键格式 - 积分排行榜   list方式存储（排名从大到小）
...
define('BAN_TYPE_LOGIN', 1);//登陆限制
define('BAN_TYPE_REG', 2);//登陆注册
defined('GOLD_FLOW_TYPE_NEW') ? : define('GOLD_FLOW_TYPE_NEW', 3);//金币流水类型--新人赠送
defined('GOLD_FLOW_TYPE_NEW') ? : define('GOLD_FLOW_TYPE_CREDIT', 2);//金币流水类型--钻石兑换
defined('GOLD_FLOW_TYPE_OLREWARD') ? : define('GOLD_FLOW_TYPE_OLREWARD', 7);//金币流水类型--在线奖励
defined('GOLD_FLOW_TYPE_SIGN') ? : define('GOLD_FLOW_TYPE_SIGN', 5);//金币流水类型--签到
defined('GOLD_FLOW_TYPE_TASK') ? : define('GOLD_FLOW_TYPE_TASK', 6);//金币流水类型--任务
defined('GOLD_FLOW_TYPE_POPU') ? : define('GOLD_FLOW_TYPE_POPU', 8);//金币流水类型--人气兑换
defined('GOLD_FLOW_TYPE_FISH') ? : define('GOLD_FLOW_TYPE_FISH', 1);//金币流水类型--捕鱼
defined('GOLD_FLOW_TYPE_NEW') ? : define('GOLD_FLOW_TYPE_GIVE', 10);//金币流水类型--钻石兑换
defined('GOLD_FLOW_TYPE_OTHER') ? : define('GOLD_FLOW_TYPE_OTHER', 9);//金币流水类型--其他